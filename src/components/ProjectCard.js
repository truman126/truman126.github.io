...
function ProjectCard(props) {
  ...
  return (
      <Card style={{display:'inline-block', width:'32rem',overflow:'hidden' }}>
        <Card.Img  style={{height: '25rem', width: '32rem', objectFit: 'scale-down', borderRadius: 'inherit'}} variant="top" src={props.img} />
        <Card.Body>
